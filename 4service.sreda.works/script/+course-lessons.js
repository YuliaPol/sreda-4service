    ...
    $(document).ready(function () {
        ...
        $(".vacancy-settings").on("click", ".add-new-item", function () {
            ...
            var newItem =
                ...
                '           <div class="vac-tools">' +
                '               <div class="input-group">' +
                '                   <input type="checkbox" class="checkbox" id="homework-block_' + id_question + '_' + id_item + '" name="homework-block_' + id_question + '_' + id_item + '"/>' +
                '                   <label for="homework-block_' + id_question + '_' + id_item + '"></label>' +
                '               </div>' +
                '           </div>' +
                '       </h4>' +
                '       <div class="vac-settings__block-content"  style="display: none;">' +
