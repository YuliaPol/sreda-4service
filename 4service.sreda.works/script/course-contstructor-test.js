    ...
    $(document).ready(function () {
        ...
        $('.content-container').on('click', '.add-questions-item', function () {
            ...
            if(block && blockItem){
                ...
                '    <label>' +
                '        <input type="text" class="answer input-shdw" data-reqired="reqired" value="" placeholder="Введите вариант ответа" name="answer_'+ block + '_' + blockItem + '_' + section + '_' + question + '_' + item + '" id="answer_'+ block + '_' + blockItem + '_' + section + '_' + question + '_' + item + '">' +
                '    </label>' +
        ...
        $('.content-container').on('click', '.add-chapter-question', function () {
            ...
            if(section && question && block && blockItem ){
                newQuestion =
                    ...
                    '        </div>' +
                    '        <div class="input-group">' +
                    '            <input type="text" placeholder="Описание вопроса (необязательно)" class="input-shdw"  id="questiondescription_' + block + '_' + blockItem + '_' + section + '_' + question + '" name="questiondescription_' + block + '_' + blockItem + '_' + section + '_' + question + '">' +
                    '        </div>' +
                    '    </div>' +
                    '    <div class="custom-table__cell">' +
                    '        <select id="questiontype_' + block + '_' + blockItem + '_' + section + '_' + question + '" name="questiontype_' + block + '_' + blockItem + '_' + section + '_' + question + '">' +
        ...
        $('.content-container').on('click', '.add-chapter-constructor', function () {
            ...
            if(block && blockItem){
                ...
                '               <input type="text" class="answer input-shdw" value="" data-reqired="reqired" placeholder="«Название»" id="chapter_' + block + '_' + blockItem + '_' + section + '" name="chapter_' + block + '_' + blockItem + '_' + section + '">' +
                '              </div>' +
